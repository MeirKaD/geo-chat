    ...
    <div className="border-t border-blue-800/30 p-3 md:p-4 bg-slate-900/50 backdrop-blur-sm safe-area-bottom">
      <form onSubmit={handleSubmit} className="flex items-center gap-2">
        <input
          ...
          placeholder="Ask any Location-related query ..."
          className="flex-1 min-w-0 px-4 py-2.5 bg-slate-800/50 border border-blue-700/40 rounded-full text-blue-50 placeholder-blue-200/70 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all text-xs"
        />
        <button
          type="submit"
          disabled={!input.trim()}
